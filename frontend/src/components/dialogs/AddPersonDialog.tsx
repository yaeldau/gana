...
export function AddPersonDialog() {
  const { isAddPersonDialogOpen, setAddPersonDialogOpen } = useAppStore();
  ...
  if (!isAddPersonDialogOpen) return null;

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Mock submission - in real app would call API
    console.log('Add person:', formData);
    alert('Person added (mock)');
